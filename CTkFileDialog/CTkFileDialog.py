...
class CTkFileDialog:
    def __init__(self, title=None, open_folder=False, initialdir=None, **kwargs):
        ...
        print(
            f"[CTkFileDialog Placeholder] Initialized with title: '{self.title}', open_folder: {self.open_folder}, initialdir: '{self.initialdir}'"
        )
        ...
        self.path = os.path.join(
            self.initialdir, "selected_dummy_folder_by_ctkfiledialog"
        )
...
if __name__ == "__main__":
    ...
    dialog = CTkFileDialog(
        title="Select Output Directory for Reports", open_folder=True, initialdir="/tmp"
    )
